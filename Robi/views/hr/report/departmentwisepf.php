...
<a class="btn btn-info active" href="hr_employeeinfo/departmentwisepf">Department Wise PF</a>
...
<h3 class="mb">Department Wise PF Report</h3>
<br/>
<?php echo Form::open('hr_employeeinfo/showdepartmentwisepf',array('method'=>'POST')); ?>
	<div class="row">
