<div class="table-responsive">
		...
		<table class="table table-bordered" align="center" border="1" width="680px" cellpadding="2" class="mytable" cellspacing="0">
			...
			<thead>
				...
				<tr>
					...
					<td style="text-align:left;"><? echo $departmentName;?></td>
				</tr>
				<tr>
	...
	<br />
	<div class="table-responsive">
		<table class="table table-bordered table-hover" align="center" border="1" width="680px" cellpadding="2" class="mytable" cellspacing="0">
...
where emp_offipro.id_department_id='$id_dept_id' and pf_amount.year='$year' and pf_amount.month='$month'","pf_amount.year,pf_amount.month,pf_amount.employee_amount,pf_amount.employeer_amount,pf_amount.total_pf_amount");
				$i=1;
